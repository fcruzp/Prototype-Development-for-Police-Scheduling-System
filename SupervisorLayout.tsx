    ...
    <div>
      ...
      <List>
        <ListItem disablePadding>
          <ListItemButton onClick={() => handleNavigation('/supervisor')}>
            <ListItemIcon>
              <DashboardIcon />
            </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton onClick={() => handleNavigation('/supervisor/shifts')}>
            <ListItemIcon>
              <CalendarMonthIcon />
            </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton onClick={() => handleNavigation('/supervisor/tasks')}>
            <ListItemIcon>
              <AssignmentIcon />
            </ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton onClick={() => handleNavigation('/supervisor/tracking')}>
            <ListItemIcon>
              <LocationOnIcon />
            </ListItemIcon>
            <ListItemText primary="Officer Tracking" />
          </ListItemButton>
        </ListItem>
        <ListItem disablePadding>
          <ListItemButton onClick={() => handleNavigation('/supervisor/reports')}>
            <ListItemIcon>
              <AssessmentIcon />
            </ListItemIcon>
      ...
      >
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div">
            Jamaica Police Department - Supervisor Portal
          </Typography>
        </Toolbar>
      </AppBar>
      <Box
